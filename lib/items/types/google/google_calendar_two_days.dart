...
final class _GoogleCalendarPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        '${loc.googleCalendarNextTwoDays}: ${calendarIds.join(', ')}',
...
class GoogleCalendarNextTwoDays extends WidgetTypeDefinition {
  GoogleCalendarNextTwoDays()
    : super(
        typeId: WidgetIds.googleCalendarTwoDays,
        nameBuilder: (ctx) =>
            AppLocalizations.of(ctx)!.widgetNameGoogleCalendarNextTwoDay,
