...
class OpenWeatherCurrent extends WidgetTypeDefinition {
  OpenWeatherCurrent()
    : super(
        typeId: WidgetIds.weatherCurrent,
        nameBuilder: (ctx) =>
            AppLocalizations.of(ctx)!.widgetNameOpenWeatherCurrent,
        defaultSize: const Size(180, 90),
      );
...
final class _OpenWeatherPanelState extends State<_OpenWeatherPanel> {
  ...
  void initState() {
    ...
    if (shouldWarmup) {
      repo.ensureTokenPresent(
        appBloc: context.read<AppWebSocketBloc>(),
        backStream: context.read<BackAppWebSocketBloc>().stream,
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Old: ValueListenableBuilder<OpenWeatherTokenStatus>
        ...
        return AnimatedSwitcher(
          ...
          child: switch ((hasLocalKey || hasBackendKey, checking)) {
            ...
            (false, false) => _panel(
              ...
              text: 'OpenWeather key missing (check config)',
            ),
          },
        );
      },
